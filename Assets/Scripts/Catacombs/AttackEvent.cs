    ...
    public class AttackEvent : HackAndSlashEvent
    {
        ...
        private void Update()
        {
            ...
            if (swipe.isFastEnough)
            {
                ...
                float dot = Mathf.Abs(Quaternion.Dot(swipeRotation, transform.rotation * Quaternion.Euler(0f, 0f, 90f))); // Absolute allows for the swipe to be in either direction, as long as it's parralell
